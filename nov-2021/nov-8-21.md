...
- NOTES - Took a ton of notes during the conference talk today!
- GITHUB - Added a new repository of the code that we worked through in the JS workshop today, and we utilized TypeScript, Next.js, Cypress, Functional React Components, TDD, and it was super straightforward and informative!
...
- **TODAY'S POSITIVES**
  ...
  - TypeScript demonstration today!
  - Next.js pros and cons were interesting to hear about!
  - Cypress was super straightforward and simple to integrate! Really easy to work with (at least for web apps)! Would prefer to use this for testing purposes before we run into unit testing cases.
  - Really enjoyed speaking with other developers!
